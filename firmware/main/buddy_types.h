...
typedef enum {
    ...
    BUDDY_PAGE_GAME_LIFE,       /* 赛博人生重开模拟器 */
    BUDDY_PAGE_VOKIE,           /* Vokie 语音助手 */
    BUDDY_PAGE_PET,
    BUDDY_PAGE_INFO,
...
typedef enum {
    ...
    BUDDY_LAUNCHER_ITEM_VOKIE,          /* Vokie 语音助手 */
    BUDDY_LAUNCHER_ITEM_GAME_LIFE,      /* 人生重开模拟器 */
...
#define BUDDY_LAUNCHER_VOKIE      BUDDY_LAUNCHER_ITEM_VOKIE
#define BUDDY_LAUNCHER_GAME_LIFE  BUDDY_LAUNCHER_ITEM_GAME_LIFE
